...
export default function PreBookBanner() {
  ...
  return (
    <div className="relative w-full z-20 pb-12 pt-8 text-center overflow-hidden flex items-center justify-center" style={{ background: '#FFF8F0', minHeight: '280px' }}>
      <style>{`
      ...
      {/* Divine Mandala Background */}
      <div className="absolute inset-0 flex items-center justify-center opacity-30 pointer-events-none">
        <div className="relative flex items-center justify-center" style={{ width: '480px', height: '480px' }}>
          
          {/* Outer Rotating Ring */}
          <svg className="absolute inset-0 drop-shadow-lg" width="480" height="480" viewBox="0 0 480 480" style={{ animation: 'spin-slow 60s linear infinite' }}>
          ...
          {/* Inner Rotating Ring */}
          <svg className="absolute inset-0" width="480" height="480" viewBox="0 0 480 480" style={{ animation: 'spin-reverse-slow 40s linear infinite' }}>
            {/* 12 Petals Layer */}
      ...
      <div className="relative z-10 w-full max-w-3xl mx-auto flex items-center justify-center drop-shadow-2xl" style={{ height: '180px' }}>
        <svg viewBox="0 0 600 200" width="100%" height="100%" className="overflow-visible">
          <defs>
            {/* A gentle arch path */}
